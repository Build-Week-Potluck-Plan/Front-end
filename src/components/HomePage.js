...
export default function HomePage() {
    return (
            ...
            <Card className='topCard'>
                <Card.Img style={{width: '50%', }} variant="left" src="https://cdn.shopify.com/s/files/1/0085/5484/0141/files/potluck4_grande.jpg?v=1589822887" alt='round-charcuterie-board'/>
            ...
            <Card className='bottomCard'>
                <Card.Img style={{width: '50%',}} variant="left" src="https://253qv1sx4ey389p9wtpp9sj0-wpengine.netdna-ssl.com/wp-content/uploads/2018/11/Dishes_at_Potluck-700x461.jpg" alt='square-charcuterie-board'/>
                <Card.Body style={{padding: '0.5em 1.2em', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
